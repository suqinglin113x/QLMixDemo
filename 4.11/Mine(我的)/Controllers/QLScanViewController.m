...
@interface QLScanViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,AVCaptureMetadataOutputObjectsDelegate> //用于处理采集信息的代理
...
- (void)setupScanWindowView
{
    ...
    UILabel * tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_scanWindow.frame), self.view.bounds.size.width, 20)];
