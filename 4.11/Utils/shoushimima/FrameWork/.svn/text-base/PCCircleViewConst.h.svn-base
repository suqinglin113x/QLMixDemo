 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(251,77,77,1)
 ...
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor rgba(250,190,190,1)

/**
 *  错误状态下外空心圆颜色
 */
//#define CircleStateErrorOutsideColor rgba(254,82,92,1)
#define CircleStateErrorOutsideColor rgba(250,190,190,1)
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(241,65,65,1)

/**
 *  错误状态内实心圆颜色
 */
//#define CircleStateErrorInsideColor rgba(254,82,92,1)
#define CircleStateErrorInsideColor rgba(241,65,65,1)
...
#define CircleStateSelectedTrangleColor [UIColor clearColor]

/**
 *  错误状态三角形颜色
 */
//#define CircleStateErrorTrangleColor rgba(254,82,92,1)
#define CircleStateErrorTrangleColor [UIColor clearColor]
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor rgba(241,65,65,1)

/**
 *  错误时连线颜色
 */
#define CircleConnectLineErrorColor rgba(241,65,65,1)

/**
 *  连线宽度
 */
#define CircleConnectLineWidth 4.0f
 ...
 */
#define CircleViewEdgeMargin 20.0f
 ...
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState rgba(251,77,77,1)
